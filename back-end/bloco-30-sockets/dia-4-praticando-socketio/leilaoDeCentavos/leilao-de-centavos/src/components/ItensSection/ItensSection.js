...
const ItensSection = () => {
  const {cellphonePrice, tvPrice, notebookPrice, cellphoneDisabled, tvDisabled, notebookDisabled, cellphoneButton, tvButton, notebookButton } = useContext(Context);
    ...
    <ItensSectionContainer>
      <ItemsContainer>
        <ItemBox>
          ...
          <ItemButtonContainer>
            <ItemButton disabled={cellphoneDisabled}>
              { cellphoneButton }
            </ItemButton>
          </ItemButtonContainer>
        </ItemBox>
